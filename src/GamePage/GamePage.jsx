...
function GamePage() {
  ...
  const handleAnswerClick = (answer) => {
    ...
    const correct = answer.toUpperCase() === questions[currentQuestionIndex].correctAnswer

    // Calculate score with badge multiplier
    if (correct) {
      const earnedScore = doubleScoreActive ? 200 : 100
      setScore(prev => prev + earnedScore)
      console.log('Score earned:', earnedScore, 'Double active:', doubleScoreActive)
    }
